  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.listTab}>
        {statuses.map(status => (
          <TouchableOpacity key={status.key} style={[styles.btnTab, type === status.status && styles.btnTabActive]} onPress={()=> {setType(status.status)}}>
            <Text style={[styles.textTab, type === status.status && styles.btnTabActiveText]}>{status.status}</Text>
          </TouchableOpacity>
        ))}
      </View>
      <FlatList
